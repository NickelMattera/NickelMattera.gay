  ...
  component: () => (
    <>
      ...
      <Section title="Experience">
        <div className={cn('mt-4 grid gap-4 items-start lg:grid-cols-2')}>
          <Experience
          ...
          <Experience
            ...
            <ul className={cn('list-disc pl-6')}>
              ...
              <li>Contribute to the education and development subcommittee by helping to source educational material from LinkedIn Learning.</li>
          ...
          <Experience company="Cision" duration="September 2016 - June 2020" title="Software Engineer">
            <ul className={cn('list-disc pl-6')}>
              <li>Contributed as a full stack engineer  working in C# and Angular.js to the Analytics Dashboard, Social Analytics Tracking, and Earned/Placed Impact areas of Cision Communication Cloud.</li>
          ...
          <Experience company="Mindtree" duration="January 2014 - September 2016" title="Software Engineer">
            <ul className={cn('list-disc pl-6')}>
              <li>Led mobile projects, such as Volvo Scout Master and Mack CV360 iPad apps, for their Delivery Center in Gainesville, FL.</li>
              <li>Responsible for estimations, creating build processes, meeting with clients, managing code quality, conducting technical interviews, and training junior engineers.</li>
          ...
          <Experience company="Zgraph" duration="November 2011 - January 2014" title="Lead Internet Engineer">
            <ul className={cn('list-disc pl-6')}>
              <li>Lead engineer overseeing projects such as Monterey Boats iPad app and National Marker Company Ecommerce website.</li>
          ...
          <Experience company="PosiMotion" duration="June 2008 - November 2011" title="Lead Programmer">
            <ul className={cn('list-disc pl-6')}>
              <li>Lead engineer overseeing projects such as National Geographic's Jigsaw and Spot It games, and the 2009 Toys R Us Big Book app.</li>
              <li>Designed and led the project for G-Park, featured in an Apple iPhone 3G commercial.</li>
              <li>Acted as a mentor to other engineers, providing support and guidance, and collaborated with individuals and companies for application publishing.</li>
            </ul>
          </Experience>
        </div>
      </Section>
